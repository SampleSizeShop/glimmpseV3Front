...
export const Gaussian_unconditional_25_input = {
  ...
  parameters_scale_factor: [ 0.1651525, 0.2623301, 0.3508015],
...
export const Gaussian_unconditional_25_output = {
  message: 'OK',
  status: 200,
  mimetype: 'application/json',
  results: [
    {test: 'Hotelling Lawley Trace', power: 0.201},
    {test: 'Hotelling Lawley Trace', power: 0.504},
    {test: 'Hotelling Lawley Trace', power: 0.797}
  ],
  model: {
