export const constants = {
  ...
  STAGES: {
    ...
    '10': 'BETWEEN_ISU_SMALLEST_GROUP',
    '11': 'BETWEEN_ISU_GROUPS',
    '12': 'GAUSSIAN_COVARIATE',
    '13': 'HYPOTHESIS_EFFECT_CHOICE',
    '14': 'HYPOTHESIS_BETWEEN',
    '15': 'HYPOTHESIS_WITHIN',
    '16': 'HYPOTHESIS_THETA_0',
    '17': 'PARAMETERS_MARGINAL_MEANS',
    '18': 'PARAMETERS_SCALE_FACTOR',
    '19': 'PARAMETERS_STANDARD_DEVIATION',
    '20': 'PARAMETERS_OUTCOME_CORRELATION',
    '21': 'PARAMETERS_REPEATED_MEASURE_OUTCOME_ST_DEV',
    '22': 'PARAMETERS_REPEATED_MEASURE_CORRELATION',
    '23': 'PARAMETERS_INTRA_CLASS_CORRELATION',
    '24': 'PARAMETERS_GAUSSIAN_COVARIATE_VARIANCE',
    '25': 'PARAMETERS_GAUSSIAN_COVARIATE_CORRELATION',
    '26': 'PARAMETERS_SCALE_FACTOR_VARIANCE',
    '27': 'OPTIONAL_SPECS_POWER_METHOD',
    '28': 'OPTIONAL_SPECS_POWER_CURVE_CHOICE',
    '29': 'OPTIONAL_SPECS_POWER_CURVE_AXES',
    '30': 'OPTIONAL_SPECS_POWER_CURVE_DATA_SERIES',
    '31': 'OPTIONAL_SPECS_CI_CHOICE',
    '32': 'OPTIONAL_SPECS_CI_ASSUMPTIONS',
    '33': 'OPTIONAL_SPECS_CI_LOWER_TAIL',
    '34': 'OPTIONAL_SPECS_CI_UPPER_TAIL',
    '35': 'OPTIONAL_SPECS_CI_BETA_SAMPLE_SIZE',
    '36': 'OPTIONAL_SPECS_CI_BETA_DESIGN_MATRIX_RANK',
    '37': 'CALCULATE'
  },
