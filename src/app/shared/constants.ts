export const constants = {
  ...
  STAGES: {
    ...
    OPTIONAL_SPECS_POWER_METHOD: 25,
    OPTIONAL_SPECS_POWER_CURVE_CHOICE: 26,
    OPTIONAL_SPECS_POWER_CURVE_AXES: 27,
    OPTIONAL_SPECS_POWER_CURVE_DATA_SERIES: 28,
    OPTIONAL_SPECS_CI_CHOICE: 29,
    OPTIONAL_SPECS_CI_ASSUMPTIONS: 30,
    OPTIONAL_SPECS_CI_LOWER_TAIL: 31,
    OPTIONAL_SPECS_CI_UPPER_TAIL: 32,
    OPTIONAL_SPECS_CI_BETA_SAMPLE_SIZE: 33,
    OPTIONAL_SPECS_CI_BETA_DESIGN_MATRIX_RANK: 34,
    CALCULATE: 35
  },
