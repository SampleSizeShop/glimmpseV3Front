export const constants = {
  ...
  STAGES: {
    ...
    BETWEEN_ISU_PREDICTORS_NAME: 9,
    BETWEEN_ISU_PREDICTORS_TYPE: 10,
    BETWEEN_ISU_PREDICTORS_GROUPS: 11,
    BETWEEN_ISU_SMALLEST_GROUP: 12,
    BETWEEN_ISU_GROUPS: 13,
    GAUSSIAN_COVARIATE: 14,
    HYPOTHESIS_EFFECT_CHOICE: 15,
    HYPOTHESIS_BETWEEN: 16,
    HYPOTHESIS_WITHIN: 17,
    HYPOTHESIS_THETA_0: 18,
    PARAMETERS_MARGINAL_MEANS: 19,
    PARAMETERS_SCALE_FACTOR: 20,
    PARAMETERS_STANDARD_DEVIATION: 21,
    PARAMETERS_OUTCOME_CORRELATION: 22,
    PARAMETERS_REPEATED_MEASURE_ST_DEV: 23,
    PARAMETERS_REPEATED_MEASURE_CORRELATION: 24,
    PARAMETERS_INTRA_CLASS_CORRELATION: 25,
    PARAMETERS_GAUSSIAN_COVARIATE_VARIANCE: 26,
    PARAMETERS_GAUSSIAN_COVARIATE_CORRELATION: 27,
    PARAMETERS_SCALE_FACTOR_VARIANCE: 28,
    OPTIONAL_SPECS_POWER_METHOD: 29,
    OPTIONAL_SPECS_POWER_CURVE_CHOICE: 30,
    OPTIONAL_SPECS_POWER_CURVE_AXES: 31,
    OPTIONAL_SPECS_POWER_CURVE_DATA_SERIES: 32,
    OPTIONAL_SPECS_CI_CHOICE: 33,
    OPTIONAL_SPECS_CI_ASSUMPTIONS: 34,
    OPTIONAL_SPECS_CI_LOWER_TAIL: 35,
    OPTIONAL_SPECS_CI_UPPER_TAIL: 36,
    OPTIONAL_SPECS_CI_BETA_SAMPLE_SIZE: 37,
    OPTIONAL_SPECS_CI_BETA_DESIGN_MATRIX_RANK: 38,
    CALCULATE: 39
  },
