export const constants = {
  ...
  STAGES: {
    ...
    GAUSSIAN_COVARIATE: 9,
    HYPOTHESIS_EFFECT_CHOICE: 10,
    HYPOTHESIS_MIXED: 11,
    HYPOTHESIS_BETWEEN: 12,
    HYPOTHESIS_WITHIN: 13,
    HYPOTHESIS_THETA_0: 14,
    BETWEEN_ISU_SMALLEST_GROUP: 15,
    BETWEEN_ISU_GROUPS: 16,
    PARAMETERS_MARGINAL_MEANS: 17,
    PARAMETERS_SCALE_FACTOR: 18,
    PARAMETERS_STANDARD_DEVIATION: 19,
    PARAMETERS_OUTCOME_CORRELATION: 20,
    PARAMETERS_REPEATED_MEASURE_ST_DEV: 21,
    PARAMETERS_REPEATED_MEASURE_CORRELATION: 22,
    PARAMETERS_INTRA_CLASS_CORRELATION: 23,
    PARAMETERS_GAUSSIAN_COVARIATE_VARIANCE: 24,
    PARAMETERS_GAUSSIAN_COVARIATE_CORRELATION: 25,
    PARAMETERS_GAUSSIAN_COVARIATE_POWER: 26,
    PARAMETERS_SCALE_FACTOR_VARIANCE: 27,
    OPTIONAL_SPECS_CONFIDENCE_INTERVALS: 28,
    CALCULATE: 29,
  },
  ...
  PARAMETERS_GAUSSIAN_COVARIATE_VARIANCE_VALIDATION_MESSAGES: {
    'covariatevariance': {
      'required': 'You must define a value for the standard deviation of your gaussian covariate.'
    },
  },
